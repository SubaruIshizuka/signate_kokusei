...
def get_svd(all_df):
    cols = [
        ...
        'workclass_occupation_diff_prod_age_educationnum',
        ...
        'native-country_diff_education-num',
        ...
        'std_marital-status_ratio_age_educationnum',
        'std_workclass_prod_age_educationnum',
        'std_marital-status_prod_age_educationnum',
        'std_race_education-num',
        'std_relationship_age',
        'std_education_prod_age_educationnum',
        'std_bin_general_ratio_age_educationnum',
        'std_race_prod_age_educationnum',
        'std_bin_general_prod_age_educationnum',
        'std_relationship_prod_age_educationnum',
        'std_relationship_ratio_age_educationnum',
        'std_sex_age',
        'std_sex_education-num',
        'std_sex_prod_age_educationnum',
        'std_sex_ratio_age_educationnum',
        'std_bin_general_education-num',
    ]
    ...
    ax.bar(range(0, n_components), var_exp, alpha=0.5, align="center", 
            label="individual explained variance ratio")
    ax.step(range(0, n_components), cum_var_exp, where="mid",
             label="cumulative explained variance ratio")
    plt.tight_layout()
    plt.savefig(FEATURE_DIR_NAME + 'va_exp_ratio.png', dpi=300, bbox_inches="tight")
    plt.close()
